...
function PasswordResetConfirm() {
    ...
    const handlePasswordResetConfirm = async () => {
        ...
        try {
            const response = await axios.post('http://192.168.8.116:8000/api/password-reset/confirm/', {
                email,
                code,
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput
                ...
                secureTextEntry
            />
            <TouchableOpacity onPress={handlePasswordResetConfirm} style={styles.button}>
